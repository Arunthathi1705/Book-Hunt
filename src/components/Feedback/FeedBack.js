...
const FeedBack = () => {
  ...
  " >
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl sm:text-3xl font-semibold text-slate-700 mb-1">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-6">
            <motion.input
              ...
              className="w-full bg-slate-100 border-none rounded-full px-4 py-2 text-md text-slate-800 outline-none focus:ring-2 focus:ring-purple-600 transition-all duration-200"
            ...
            <motion.textarea
              ...
              transition={{ duration: 0.2 }}
              className="w-full bg-slate-100 border-none rounded-lg px-3 py-1.5 text-sm text-slate-800 outline-none focus:ring-2 focus:ring-purple-600 transition-all duration-200"
